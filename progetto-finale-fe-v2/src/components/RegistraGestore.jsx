...
function RegistraGestore() {
  ...
  const validateForm = () => {
    try {
      ...
      if (
        !datiRegistrazioneGestore.username ||
        !datiRegistrazioneGestore.email ||
        !datiRegistrazioneGestore.password ||
        !datiRegistrazioneGestore.codiceGestore
      ) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8080/api/utenti/registra/gestore",
        datiRegistrazioneGestore
      );
